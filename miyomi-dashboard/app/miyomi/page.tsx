...
export default function MiyomiProfile() {
  ...
  const [activeTab, setActiveTab] = useState<'vitals' | 'casts' | 'videos' | 'performance' | 'dashboard' | 'upload' | 'training' | 'config'>('vitals');
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex gap-8">
            {(viewMode === 'public' 
              ...
              : ['dashboard', 'upload', 'training', 'config'] as const
            ).map((tab) => (
              <button
                key={tab}
